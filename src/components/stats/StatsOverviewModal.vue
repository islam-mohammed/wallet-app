    ...
    >
      ...
      >
        ...
        >
          ...
          <div class="absolute right-5 top-5 flex flex-col items-center gap-1 text-[11px] text-slate-100">
            <div class="relative flex h-8 w-8 items-center justify-center rounded-full bg-slate-900/80">
              <span
